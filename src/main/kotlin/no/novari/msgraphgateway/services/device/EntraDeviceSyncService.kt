...
import no.novari.msgraphgateway.kafka.device.EntraDeviceProducerService
import no.novari.msgraphgateway.repository.device.DeviceStateRepository
            ...
            val published =
                if (republishAll) {
                    upsertAndPublishAll(
                        ...
                        toDto = { device -> EntraDevice(device) },
