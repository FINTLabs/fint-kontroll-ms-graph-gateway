...
import no.novari.msgraphgateway.kafka.ResourceGroup
...
class EntraGroupCommandService(
    ...
    fun deleteGroup(resourceGroupId: String) {
        // Her trenger du mapping fra resourceGroupId -> Entra group objectId.
        // Hvis Kafka-key IKKE er Entra objectId, må du først slå opp gruppen.
